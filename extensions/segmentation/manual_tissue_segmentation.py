...
from .manual_segmentation import clean_image, get_sa_contours
from .polygon_selector import OpenPolygonSelectorSpline
...
class Actions:
    def __init__(
        ...
        *,
        ...
        self.epi_poly = OpenPolygonSelectorSpline(
        ...
        self.endo_poly = OpenPolygonSelectorSpline(
...
def manual_tissue_segmentation(
    mask_3c: NDArray,
    average_map: NDArray,
    ha_map: NDArray,
    md_map: NDArray,
