...
magick montage  ('results_a\*' + $slice_num + '.png') ('results_b\*' + $slice_num + '.png') -gravity Center -tile 6x3 -geometry 500x500+5+5 -depth 8 ("results_montage_" + $folder_id + "_slice_" + $slice_num + ".png")
